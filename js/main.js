...
function createCards(projetos) {
    ...
    projetos.forEach(projeto => {
        ...
        let celularSvg = projeto.adaptado_para.celular ? `
        ...
        ` : '';
        // Se o valor armazenado no json for true, define a variável como o svg, caso seja false, define como vazio
        let pcSvg = projeto.adaptado_para.pc ? `
        ...
        let siteLink = projeto.links.site !== "n/a" ? `<a class="card-link site-link btn" href="${json.links.site}" target="_blank">Ver site</a>` : '';
        // Se o valor armazenado no json for diferente de "n/a", cria a tag "a" com o link referente. Caso seja "n/a", define como vazio
        let githubLink = projeto.links.github !== "n/a" ? `<a class="card-link github-link btn" href="${json.links.github}" target="_blank">GitHub</a>` : '';
        ...
        Object.values(projeto.technologies).forEach(tech => {
